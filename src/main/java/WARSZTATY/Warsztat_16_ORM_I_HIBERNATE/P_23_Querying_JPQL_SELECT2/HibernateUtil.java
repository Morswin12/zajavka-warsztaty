...
public class HibernateUtil {
    ...
    private static final Map<String, Object> SETTINGS = Map.ofEntries(
            ...
            Map.entry( Environment.URL, "jdbc:postgresql://localhost:5432/warsztat_16_P23"),
            ...
            Map.entry( Environment.FORMAT_SQL, false) // żeby nie drukowało się w konsoli rozwinięcie całości zapytania, a jedynie w jednej linijce
    );
